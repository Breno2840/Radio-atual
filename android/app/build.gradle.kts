...
android {    
    ...
    signingConfigs {    
        create("release") {    
            ...
            storePassword = signingProperties.getProperty("storePassword") ?: System.getenv("KEYSTORE_PASSWORD")    
            keyPassword = signingProperties.getProperty("keyPassword") ?: System.getenv("KEY_PASSWORD")    
        }    
    }    
